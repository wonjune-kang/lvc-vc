...
class VCTK_Wav2Vec(VCTK):
    ...
    def __getitem__(self, idx):
        # Get data for baseline utterance.
        utt_data = self.data[idx]
        speaker_id1, audio1, perturbed_audio1, speaker_feat1, f0_norm1 = self.get_utterance_data(utt_data)
        ...
        if not self.train:
            ...
            _, audio_new, perturbed_audio_new, speaker_feat_new, f0_new = self.get_utterance_data(utt_data_new)
    ...
    def get_utterance_data(self, utt_data):
        ...
        if self.train:
            ...
            perturbed_audio = perturbed_audio[audio_start:audio_start + self.hp.audio.segment_length]
